...
!https://github.com/barrettj/SVProgressHUD/blob/master/ProgressBarSS.png?raw=true!


By default, SVProgressHUD uses an indeterminate progress indicator (UIActivityIndicator).  If you want a progress bar, set the indicator to SVProgressHUDIndicatorTypeProgressBar
...
You can then update the progress by calling
